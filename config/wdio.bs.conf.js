...
exports.config = {
  ...
  specs: [
    process.cwd() + '/tests/specs/login.spec.js',
    process.cwd() + '/tests/specs/forms.spec.js',
    process.cwd() + '/tests/specs/swipe.spec.js',
    process.cwd() + '/tests/specs/drag.spec.js',
    process.cwd() + '/tests/specs/navigation.spec.js',
    process.cwd() + '/tests/specs/webview.spec.js',
  ],
  exclude: [],
